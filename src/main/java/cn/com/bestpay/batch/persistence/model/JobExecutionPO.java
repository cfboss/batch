...
public class JobExecutionPO {
    ...
    public String getJobConfigLocation() {
        return jobConfigLocation;
    }

    public void setJobConfigLocation(String jobConfigLocation) {
        this.jobConfigLocation = jobConfigLocation == null ? null : jobConfigLocation.trim();
    }
}